...
export const mockAAI50: AAI50Entry[] = [
  ...
  { rank: 11, name: 'COOKIE',      ticker: 'COOKIE',  score: 1098, change:  1.8, direction: 'up'   },
  { rank: 12, name: 'VIRTUAL',     ticker: 'VIRTUAL', score: 1054, change: -0.4, direction: 'down' },
  { rank: 13, name: 'NUMERAI',     ticker: 'NMR',     score: 1011, change:  0.9, direction: 'up'   },
  { rank: 14, name: 'AUTONOLAS',   ticker: 'PEARL',   score:  978, change: -1.7, direction: 'down' },
  { rank: 15, name: 'ZEREBRO',     ticker: 'ZEREBRO', score:  944, change:  2.5, direction: 'up'   },
  { rank: 16, name: 'SPECTRAL',    ticker: 'SPEC',    score:  912, change:  0.3, direction: 'up'   },
  { rank: 17, name: 'POND',        ticker: 'POND',    score:  887, change: -3.1, direction: 'down' },
  { rank: 18, name: 'FREYSA',      ticker: 'FAI',     score:  861, change:  1.2, direction: 'up'   },
  { rank: 19, name: 'VADER',       ticker: 'VADER',   score:  834, change:  0.0, direction: 'flat' },
  { rank: 20, name: 'MORPHEUS',    ticker: 'MOR',     score:  809, change: -0.6, direction: 'down' },
  { rank: 21, name: 'SENTIENT',    ticker: 'SENT',    score:  783, change:  4.1, direction: 'up'   },
  { rank: 22, name: 'ROBOAGENT',   ticker: 'RBOT',    score:  761, change: -1.0, direction: 'down' },
  { rank: 23, name: 'THEORIQ',     ticker: 'AI',      score:  738, change:  0.7, direction: 'up'   },
  { rank: 24, name: 'SIMULACRA',   ticker: 'SIM',     score:  714, change:  2.9, direction: 'up'   },
  { rank: 25, name: 'KIRA',        ticker: 'KIRA',    score:  691, change: -2.4, direction: 'down' },
  { rank: 26, name: 'NEURAL',      ticker: 'NTRL',    score:  668, change:  1.5, direction: 'up'   },
  { rank: 27, name: 'ELIZA',       ticker: 'ELZ',     score:  645, change:  0.2, direction: 'up'   },
  { rank: 28, name: 'ARBIUS',      ticker: 'AIUS',    score:  621, change: -0.9, direction: 'down' },
  { rank: 29, name: 'POLYWRAP',    ticker: 'WRAP',    score:  599, change:  3.6, direction: 'up'   },
  { rank: 30, name: 'DECENTRAL',   ticker: 'AGIX',    score:  577, change: -1.8, direction: 'down' },
  { rank: 31, name: 'FETCH',       ticker: 'FET',     score:  554, change:  0.5, direction: 'up'   },
  { rank: 32, name: 'CORTEX-7',    ticker: 'CTX7',    score:  531, change:  1.1, direction: 'up'   },
  { rank: 33, name: 'SINGULARITY', ticker: 'SING',    score:  509, change: -4.2, direction: 'down' },
  { rank: 34, name: 'SYNAPSE',     ticker: 'SYN',     score:  487, change:  0.8, direction: 'up'   },
  { rank: 35, name: 'ATLAS',       ticker: 'ATLS',    score:  465, change: -0.3, direction: 'down' },
  { rank: 36, name: 'ORACLE',      ticker: 'ORC',     score:  443, change:  2.2, direction: 'up'   },
  { rank: 37, name: 'NEXUS',       ticker: 'NXS',     score:  421, change: -1.4, direction: 'down' },
  { rank: 38, name: 'CIPHER',      ticker: 'CIPH',    score:  399, change:  0.0, direction: 'flat' },
  { rank: 39, name: 'PHANTOM',     ticker: 'PHM',     score:  377, change:  1.7, direction: 'up'   },
  { rank: 40, name: 'VECTOR',      ticker: 'VEC',     score:  355, change: -2.8, direction: 'down' },
  { rank: 41, name: 'ARCHON',      ticker: 'ARCH',    score:  333, change:  0.4, direction: 'up'   },
  { rank: 42, name: 'DAEDALUS',    ticker: 'DAE',     score:  311, change:  3.0, direction: 'up'   },
  { rank: 43, name: 'SOLACE',      ticker: 'SLC',     score:  289, change: -0.7, direction: 'down' },
  { rank: 44, name: 'MERIDIAN',    ticker: 'MRD',     score:  267, change:  1.3, direction: 'up'   },
  { rank: 45, name: 'AETHER',      ticker: 'AETH',    score:  245, change: -3.5, direction: 'down' },
  { rank: 46, name: 'STRATUM',     ticker: 'STRT',    score:  223, change:  0.1, direction: 'up'   },
  { rank: 47, name: 'LUMINA',      ticker: 'LMN',     score:  201, change: -1.1, direction: 'down' },
  { rank: 48, name: 'QUASAR',      ticker: 'QSR',     score:  179, change:  2.6, direction: 'up'   },
  { rank: 49, name: 'ZENITH',      ticker: 'ZNT',     score:  157, change: -0.5, direction: 'down' },
  { rank: 50, name: 'APEX',        ticker: 'APEX',    score:  135, change:  0.9, direction: 'up'   },
]
